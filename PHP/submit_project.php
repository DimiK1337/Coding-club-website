...
$sql_insert = "INSERT INTO $db_table (`project_name`,`user_name`,`user_email`,`media_links`,`description`) VALUES ('$project_name','$user_name','$user_email','$media_links','$description')";
